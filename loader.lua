-- Full Script: Mr Glitch Hacks GUI with All Features
...
backgroundFrame.Size = UDim2.new(0, 420, 0, 460)
backgroundFrame.Position = UDim2.new(0.5, -210, 0.5, -230)
...
-- Logic: Show GUI after intro
wait(1.5)
ts:Create(intro, TweenInfo.new(2), {TextTransparency = 1, BackgroundTransparency = 1}):Play()
wait(2)
intro:Destroy()
